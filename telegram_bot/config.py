...
# Telegram
bot_token: str
admin_chat_ids: list[int]  # Chat IDs die Admin-Befehle nutzen dürfen
...
# Timeouts
analysis_timeout: int = 30  # Sekunden
ml_training_timeout: int = 300  # 5 Minuten
```

def load_bot_config() -> BotConfig:
“””
Lädt Bot-Konfiguration aus Environment-Variablen oder secrets

```
Environment-Variablen:
    TELEGRAM_BOT_TOKEN - Bot Token von @BotFather
    TELEGRAM_ADMIN_CHAT_IDS - Komma-separierte Liste von Admin Chat IDs
"""
...
if not bot_token:
    raise ValueError(
        ...
        "Setze Environment-Variable oder füge zu .streamlit/secrets.toml hinzu:\n"
        "[telegram]\n"
...
“”“Erstellt Rate-Limit Key für User”””
